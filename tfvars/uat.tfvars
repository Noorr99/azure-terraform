...
resource_group_name = "rg-census-uat-001"
...
# Virtual Network
vnet_name          = "vnet-census-uat-001"
vnet_address_space = ["172.40.1.128/26"]

# Shared Subnet (for SQL, Key Vault, Data Lake)
shared_subnet_name           = "snet-census-pe-001"
shared_subnet_address_prefix = ["172.40.1.128/27"]

# Secondary Subnet Free
secondary_subnet_name           = "snet-census-secondary-001"
secondary_subnet_address_prefix = ["172.40.1.160/27"]

# Key Vault
key_vault_name = "kv-census-uat-001"
...
# Data Factory
data_factory_name          = "adf-census-uat-001"
public_network_enabled     = false
data_factory_identity_type = "SystemAssigned"

/*
# Cognitive Service
cognitive_service_name = "cv-census-uat-001"  // "cog-customvision-uat-001"
